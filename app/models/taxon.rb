class Taxon < ActiveRecord::Base
  # I moved the model here because I couldn't get this model to stop adding a trailing slash to permalink field.
  # don't know why moving it here fixed it.  might have something to do with the system being confused about what 
  # version of spree is getting loaded (bundler issue?)
